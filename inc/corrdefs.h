...
enum {CALSRC, CALTS, OBSTS, ANT, BLINE, NBLSOL, NANTSOL, DELAY, PHASE, CALKEYWORDS};
 char CalKeyWords[CALKEYWORDS][32] = 
     { [CALSRC] = "CALSRC", [CALTS] = "CALTS", [OBSTS] = "OBSTS", [ANT] = "ANT",
       [BLINE] = "BLINE", [NBLSOL] = "NBLSOL", [NANTSOL] = "NANTSOL", 
...
{ int sec;                  // Second value since beginning of session 
 ...
 int ArrPhRefAnt= N01S;      // Phase center of the entire array. All delays and
                            // phases are ultimately referenced to this.
/*
...
*/
/*
long get_corr_metadata (FILE *, CorrHdrType **,  MetaPktType **, PackBlineHdrType **);
int get_next_corrrec(FILE *, long, CorrHdrType *, ProjParType *, int *);
int corrmap(CorrHdrType *, MetaPktType *, PackBlineHdrType *, ProjParType *, int *);
*/
#endif // _HDR_H
