...
int FITSchav(int argc, char **argv )
{
 PlotParType plot;
 ProjParType proj;
 int kk=16;
...
int main(int argc, char **argv )
{
  ...
  optrega(&FITSFileErr , OPT_STRING, 'j', "jin"   , "Input FITS error bar File" );
