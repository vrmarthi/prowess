...
int plotall(int argc, char **argv )
{
 PlotParType plot;
 char solfilename[120];

 plot.driver = dev;
 strcpy(solfilename, solfile);
...
{
  optrega(&solfile , OPT_STRING, 'i', "in"   , "Input Solution File" );
