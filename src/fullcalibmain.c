...
int fullcal(int argc, char **argv )
{
 int status = 0;
 int ch, del_iter = 0;
 ...
 { /*Gain calibration g(t,p) */
   ...
   fprintf(finfo, "%s Bandpass [ %3ld / %3d ] converged in %3d iterations\r", info, solno, proj.nrecs, proj.iter);
